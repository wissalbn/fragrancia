...
echo "<a href='add_client.php' class='btn btn-primary'>Ajouter un client</a>";
...
if ($resultat_client && mysqli_num_rows($resultat_client) > 0) {
    ...
    while ($row_client = mysqli_fetch_assoc($resultat_client)) {
        ...
        echo "<td><a href='delete_client.php?id=" . $row_client["IDCLIENT"] . "' class='btn btn-danger'>Supprimer</a></td></tr>";
