    ...
    <div class="labels">
        <label for="exemple">
            <div class="label-container">
                <img class="label-content" src="../images/icones/Delivery.png" alt="Image">
                <span>Livraison rapide</span>
            </div>
        </label>
        <label for="exemple">
            <div class="label-container">
                <img class="label-content" src="../images/icones/paiement-a-la-livraison.png" alt="Image">
                <span>Payement à la livraison</span>
            </div>
        </label>
        <label for="exemple">
            <div class="label-container">
                <img class="label-content" src="../images/icones/Successful Delivery.png" alt="Image">
